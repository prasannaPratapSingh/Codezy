...
const {contestCreator, getContest, getContestById, runContestCode, submitContestCode,getLeaderboard } = require('../controllers/createContest');
...
contestRouter.get('/leaderboard/:id',userMiddleware,getLeaderboard);
